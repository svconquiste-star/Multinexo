      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center text-white mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Quer Escalar seu Negócio com IA e Marketing Inteligente?
          </h2>
          <p className="text-xl text-white text-opacity-90 mb-8">
            Fale com a MULTINEXO e descubra como transformar tráfego em crescimento previsível. Automatizamos atendimento, captação e vendas para gerar clientes todos os dias.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl p-12 shadow-2xl">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Automação com IA</p>
                  <p className="text-gray-600">Estruturamos funis inteligentes que geram clientes todos os dias</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Tráfego Pago Focado em ROI</p>
                  <p className="text-gray-600">Estratégias de crescimento previsível e mensurável</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
        ...
        <div className="text-center">
          <p className="text-white text-opacity-80">
            Transformamos empresas locais e experts em máquinas previsíveis de crescimento com IA + Marketing
          </p>
        </div>
      </div>
    </section>
